...
function setUpdate(id){
    ...
    document.getElementById('bntUpdate').style.display = "inline-block";
...
function resetForm(){
    ...
    document.getElementById('bntUpdate').style.display = "none";
...
function validation(){
    ...
    if(amount === ''){
        ...
        errors += '<p>Fill out a valid a mount</p>';
    }

    if(value === ''){
        errors += '<p>Fill out a value</p>';
    } else if (value != parseFloat(value)){
        errors += '<p>Fill out a valid a value</p>';
    }
    if(errors != ''){
